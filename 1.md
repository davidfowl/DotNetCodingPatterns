...
## Using Microsoft.Extensions.ObjectPool to do object pooling

Object pooling is useful when you want to reduce GC pressure by reusing instances of objects that are expensive to create or large. **Microsoft.Extensions.ObjectPool** provides a nice abstraction for object pooling.
